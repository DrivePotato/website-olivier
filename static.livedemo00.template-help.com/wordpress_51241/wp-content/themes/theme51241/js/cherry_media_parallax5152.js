            ...
            return this.each(function(){
                ...
                function addEventsFunction(){
                    ...
                    windowSelector.on("resize",
                        function(){
                            if(statusDevice=="desktop"){
                                setTimeout(mainResizeFunction, 10);
                            }
                        }
                    ).trigger('resize');
                }
                ...
                /*function parallaxEffect(){
                    ...
                    innerHolderHeight = thisHeight*bufferRatio;
                    heightBuffer = innerHolderHeight-thisHeight;
                    startScrollTop = documentScrollTop;
                    endScrollTop = documentScrollTop - thisHeight;
                    visibleScrollValue = startScrollTop - endScrollTop;
                    ...
                    if( ( startScrollTop > thisOffsetTop ) && ( endScrollTop < thisOffsetTop ) ){
                        pixelScrolled = documentScrollTop - (thisOffsetTop - windowHeight);
                        percentScrolled = (pixelScrolled / visibleScrollValue)-1;
                        deltaTopScrollVal = heightBuffer * percentScrolled;
                ...
                function videoResize(obj, container){
                    ...
                    imgWidth = obj.width();
                    newImgLeft=-(imgWidth-container.width())*.5;
